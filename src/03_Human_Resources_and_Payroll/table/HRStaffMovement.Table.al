Table 85295 "HR Staff Movement"
{
    fields
    {
        ...
        field(50006; "Reporting Reasons"; Option)
        {
        ...
        field(50007; "Reporting Date"; Date)
        {
            trigger OnValidate()
            begin
                dates.Reset();
        ...
        field(50008; "Absent Reasons"; Option)
        {
        ...
        field(50009; "Absent From Date"; Date)
        {
        }
        field(50010; "Release Staff"; Code[20])
        {
            TableRelation = "HR-Employee"."No.";
        }
        field(50011; "Duties While Staff Is Away"; Text[250])
        {
        }
        ...
        field(50024; "Staff Movement Type"; Option)
        {
