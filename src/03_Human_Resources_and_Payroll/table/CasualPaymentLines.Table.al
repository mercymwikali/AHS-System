Table 85480 "Casual Payment Lines"
{
    fields
    {
        ...
        field(50010; "Basic Amount"; Decimal)
        {
        }
        field(50011; "PAYE Amount"; Decimal)
        {
        }
        field(50012; "NSSF Amount"; Decimal)
        {
        }
        field(50013; "NHIF Amount"; Decimal)
        {
        }
        field(50014; "Employee No"; Code[10])
        {
            TableRelation = if ("Employee Type" = filter(Permanent)) "HR-Employee"."No." where("Full / Part Time" = filter("Full Time"))
            else
            if ("Employee Type" = filter(Casual)) "Casual Employees"."Casual No" where(Type = filter(Casual))
            else
            if ("Employee Type" = filter("Part-Timer")) "Casual Employees"."Casual No" where(Type = filter("Part-Timer"));
        ...
        field(50015; "Employee Name"; Text[50])
        {
        }
        field(50016; "Bank Code"; Code[50])
        {
        ...
        field(50017; "Bank Name"; Text[50])
        {
        }
        field(50018; "Bank Account No"; Code[30])
        {
        }
        field(50019; "Dimension Set ID"; Integer)
        {
        ...
        field(50020; "Rate per Month"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(50023; "Pay Stutatories"; Option)
        {
            BlankZero = true;
            DataClassification = ToBeClassified;
            ...
            begin
                ...
                if "Pay Stutatories" = "pay stutatories"::Yes then begin
                    ...
                    if NSSReliefSetUp."Use Part Time SHIF Rates" = true then
                        "NHIF Amount" := NSSReliefSetUp."Part timer Tax Rate"
                    else
        ...
        field(50024; Occupation; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(50025; "Rate per Date"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50026; "Pay Rate"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(50027; "Period (Month)"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(50028; "Net Pay"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50029; "Payroll Period"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(50030; "ID Number"; Code[30])
        {
            DataClassification = ToBeClassified;
        ...
        field(50031; "Pension Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50032; "KUSU Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50033; "UASU Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50034; "Employee Type"; Option)
        {
            DataClassification = ToBeClassified;
    ...
    var
        CasualObject: Record "Casual Employees";
