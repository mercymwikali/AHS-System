Table 85441 "HR Training Needs Analysis"
{
    ...
    fields
    {
        ...
        field(50002; "Proposed Start Date"; Date)
        {
        }
        field(50003; "Proposed End Date"; Date)
        {
        }
        ...
        field(50008; "Need Source"; Option)
        {
        ...
        field(50009; Directorate; Code[20])
        {
        ...
        field(50012; "Qualification Code"; Code[20])
        {
        ...
        field(50013; "Qualification Type"; Code[30])
        {
            NotBlank = true;
            TableRelation = "HR Lookup Values".Code where(Type = const("Qualification Type"));
        }
        field(50014; "Qualification Description"; Text[80])
        {
        }
        field(50015; "Training Applicants"; Integer)
        {
            CalcFormula = count("HR Training Applications" where("Course Title" = field(Code)));
            FieldClass = FlowField;
        }
        field(50016; "Training Applicants (Passed)"; Integer)
        {
            CalcFormula = count("HR Training Applications" where("Course Title" = field(Code),
                                                                  "Training Evaluation Results" = const(Passed)));
            FieldClass = FlowField;
        }
        field(50017; "Training Applicants (Failed)"; Integer)
        {
            CalcFormula = count("HR Training Applications" where("Course Title" = field(Code),
                                                                  "Training Evaluation Results" = const(Failed)));
            FieldClass = FlowField;
        }
        field(50018; "No of Required Participants"; Integer)
        {
        }
        field(50019; "Nature of Training"; Option)
        {
            OptionCaption = ' ,Internal,External,Self,E-Learning';
            OptionMembers = " ",Internal,External,Self,"E-Learning";
        }
        field(50020; "Training Type"; Option)
        {
            OptionCaption = ',Long course,Short Course,Seminar,Workshop';
            OptionMembers = ,"Long course","Short Course",Seminar,Workshop;
        }
        field(50021; "Course Version"; Code[20])
        {
        }
        field(50022; "Course Version Description"; Text[200])
        {
        }
        field(50023; "Individual Course"; Boolean)
        {
        }
        ...
        field(50025; "Quarter Offered"; Option)
        {
        ...
        field(50026; "Application Date"; Date)
        {
            Editable = false;
        }
        ...
        field(50028; "Training category"; Option)
        {
            OptionCaption = 'Individual,Group';
            OptionMembers = Individual,Group;
        }
        field(50029; "No of Participants"; Integer)
        {
        ...
        field(50030; "Directorate Name"; Text[100])
        {
            Editable = false;
        }
        ...
        field(50032; "Employee Name"; Text[50])
        {
        }
        field(50033; Station; Code[20])
        {
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(2));
        ...
        field(50034; "Course Code"; Code[20])
        {
            NotBlank = true;
        ...
        field(50035; "Training Status"; Option)
        {
        ...
        field(50036; "Table ID"; Integer)
        {
        }
        field(50037; "Employee No."; Code[10])
        {
            NotBlank = false;
        ...
        field(50038; "Station Name"; Text[50])
        {
            Editable = false;
        }
        field(50039; "No. Series"; Code[30])
        {
        }
