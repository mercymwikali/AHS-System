Table 85280 "HR Applicants Shortlist"
{
    fields
    {
        field(50000; "Job Application No"; Code[20])
        {
            Editable = true;
            NotBlank = true;
            TableRelation = "HR Job Applications"."Application No" where("Job Applied For" = field("Job ID"));
        ...
        field(50001; "Stage Score"; Decimal)
        {
            Editable = false;
        }
        ...
        field(50003; "Applicant Name"; Text[100])
        {
            Editable = false;
        }
        field(50004; "ID No"; Text[100])
        {
            Editable = false;
        }
        ...
        field(50006; "Marital Status"; Option)
        {
            Editable = false;
            OptionCaption = ' ,Single,Married,Separated,Divorced,Widow(er),Other';
            OptionMembers = " ",Single,Married,Separated,Divorced,"Widow(er)",Other;
        }
        field(50007; "Manual Change"; Boolean)
        {
            Editable = false;
        }
        field(50008; Employ; Boolean)
        {
            trigger OnValidate()
            begin
                /*
        ...
        field(50010; Position; Integer)
        {
        }
        field(50011; "Reporting Date"; Date)
        {
        }
        field(50012; "Shortlisting Officer"; Code[30])
        {
            TableRelation = "User Setup"."User ID";
        }
        field(50013; "Job Applied for"; Text[100])
        {
        }
        field(50014; "Line No"; Integer)
        {
            AutoIncrement = true;
        }
        ...
        field(50016; "Job ID"; Code[20])
        {
        }
        field(50017; "Employee Requisition No"; Code[10])
        {
        }
        field(50018; "Shortlist Officer Count"; Integer)
        {
