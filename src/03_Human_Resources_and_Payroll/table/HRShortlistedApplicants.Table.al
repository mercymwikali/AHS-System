Table 85434 "HR Shortlisted Applicants"
{
    fields
    {
        field(50000; "Employee Requisition No"; Code[20])
        {
            Editable = false;
            NotBlank = true;
            TableRelation = "HR Employee Requisitions"."Requisition No.";
        }
        field(50001; "Stage Code"; Code[20])
        {
            Editable = false;
            NotBlank = true;
        }
        field(50002; "Job Application No"; Code[20])
        {
            Editable = false;
            NotBlank = true;
            TableRelation = Applicants."Application No";
        }
        field(50003; "Stage Score"; Decimal)
        {
            Editable = false;
        }
        field(50004; Qualified; Boolean)
        {
        }
        field(50005; "First Name"; Text[100])
        {
            Editable = false;
        }
        ...
        field(50007; "Last Name"; Text[100])
        {
            Editable = false;
        }
        field(50008; "ID No"; Text[100])
        {
            Editable = false;
        }
        ...
        field(50011; "Manual Change"; Boolean)
        {
            Editable = false;
        }
        field(50012; Employ; Boolean)
        {
            trigger OnValidate()
            begin
                /*
        ...
        field(50014; Position; Integer)
        {
        }
        field(50015; "Reporting Date"; Date)
        {
        }
        field(50016; "Email"; text[100])
        {
        }
        field(50017; "Mandatory"; Boolean)
        {
        }
        field(50018; "Total Score"; Decimal)
        {
        }
        field(50019; "Experience Score"; Decimal)
        {
        }
        field(50020; "Publication Score"; Decimal)
        {
        }
        field(50021; "Job ID"; code[20])
        {
        }
        field(50022; "E-Mail"; text[100])
        {
        }
    }
