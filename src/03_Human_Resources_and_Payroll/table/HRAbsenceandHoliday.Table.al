Table 85389 "HR Absence and Holiday"
{
...
//                    Cost:= "Days Lost" * emp."Daily Rate";
        ...
        field(50007; "Additional Cost"; Decimal)
        {
            trigger OnValidate()
            begin
                "Total Cost" := Cost + "% On Cost" + "Additional Cost";
        ...
        field(50008; "Total Cost"; Decimal)
        {
        }
        field(50009; "Hours Lost"; Integer)
        {
        }
        field(50010; "Job Title"; Text[30])
        {
        }
        field(50011; Department; Code[10])
        {
        }
        field(50012; "Employee First Name"; Text[30])
        {
        }
        field(50013; "Employee Last Name"; Text[30])
        {
        }
        field(50014; "Resource No."; Code[20])
        {
            // CalcFormula = lookup("HR Employee".Field3691476 where ("No."=field("Employee No.")));
            // FieldClass = FlowField;
        }
        field(50015; Comment; Boolean)
        {
