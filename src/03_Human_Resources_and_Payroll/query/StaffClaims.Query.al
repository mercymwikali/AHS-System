Query 85201 "Staff Claims"
{
    elements
    {
        dataitem(Staff_Claims_Header; "Staff Claims Header")
        {
            column(No; "No.")
            {
            }
            ...
            column(Currency_Reciprical; "Currency Reciprical")
            {
            }
            column(Current_Source_A_C_Bal; "Current Source A/C Bal.")
            {
            }
            column(Cancellation_Remarks; "Cancellation Remarks")
            {
            }
            column(Register_Number; "Register Number")
            {
            }
            column(From_Entry_No; "From Entry No.")
            {
            }
            column(To_Entry_No; "To Entry No.")
            {
            }
            column(Invoice_Currency_Code; "Invoice Currency Code")
            {
            }
            column(Total_Net_Amount_LCY; "Total Net Amount LCY")
            {
            }
