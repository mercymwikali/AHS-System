TableExtension 85007 "Bank Acc. Recon Line Ext" extends "Bank Acc. Reconciliation Line"
{
    ...
    fields
    {
        ...
        field(50102; "Notes Line 1"; Text[250])
        {
        }
        field(50103; "Notes Line 4"; Text[250])
        {
        }
        // field(50104; Reconciled; Boolean)
        // {
        //     trigger OnValidate()
        //     begin
        ...
        //     end;
        // }
        field(50105; "Notes Line 2"; Text[250])
        {
        }
        field(50106; "Notes Line 3"; Text[250])
        {
        }
        field(50107; "Notes Line 5"; Text[250])
        {
        }
        field(50108; "Notes Line 6"; Text[250])
        {
        }
        field(50109; Imported; Boolean)
        {
        }
        field(50110; Reversed; Boolean)
        {
            Caption = 'Reversed';
        }
        field(50111; "Bank Ledger Entry Line No"; Integer)
        {
        }
        field(50112; "Bank Statement Entry Line No"; Integer)
        {
        }
    }
    keys
