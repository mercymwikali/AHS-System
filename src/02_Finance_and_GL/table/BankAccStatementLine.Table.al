Table 85070 "Bank Acc. Statement Line"
{
    fields
    {
        ...
        field(50012; "Ready for Application"; Boolean)
        {
            Caption = 'Ready for Application';
        }
        field(50013; "Check No."; Code[20])
        {
            Caption = 'Check No.';
        }
        field(50014; "Related-Party Name"; Text[50])
        {
            Caption = 'Related-Party Name';
        }
        field(50015; "Additional Transaction Info"; Text[100])
        {
            Caption = 'Additional Transaction Info';
        }
        field(50016; "Data Exch. Entry No."; Integer)
        {
            Caption = 'Posting Exch. Entry No.';
            Editable = false;
            TableRelation = "Data Exch.";
        }
        field(50017; "Data Exch. Line No."; Integer)
        {
            Caption = 'Posting Exch. Line No.';
            Editable = false;
        }
        field(50018; "Statement Type"; Option)
        {
        ...
        field(50021; "Transaction Text"; Text[140])
        {
        ...
        field(50022; "Related-Party Bank Acc. No."; Text[50])
        {
            Caption = 'Related-Party Bank Acc. No.';
        }
        field(50023; "Related-Party Address"; Text[100])
        {
            Caption = 'Related-Party Address';
        }
        field(50024; "Related-Party City"; Text[50])
        {
        ...
        field(50027; "Match Confidence"; Option)
        {
        ...
        field(50028; "Match Quality"; Integer)
        {
        ...
        field(50029; "Sorting Order"; Integer)
        {
