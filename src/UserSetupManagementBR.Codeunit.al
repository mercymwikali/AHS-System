Codeunit 52202436 "User Setup Management BR"
{
    ...
    procedure CheckRespCenter(DocType: Option Sales,Purchase,Service; AccRespCenter: Code[50]): Boolean
    begin
        exit(CheckRespCenter2(DocType, AccRespCenter, UserId));
    end;

    procedure CheckRespCenter2(DocType: Option Sales,Purchase,Service; AccRespCenter: Code[50]; UserCode: Code[50]): Boolean
    begin
        case DocType of
            Doctype::Sales:
    ...
    begin
        ...
        case DimensionNo of
            ...
            2:
                begin
                    if (UserSetup.Get(UserCode)) and (UserCode <> '') then
                        if UserSetup.Department <> '' then
                            DimensionVal := UserSetup.Department;
                    exit(DimensionVal);
                end;
            3:
                begin
