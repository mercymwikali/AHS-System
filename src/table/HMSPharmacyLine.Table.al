table 85220 "HMS Pharmacy Line"
{
    fields
    {
        ...
        field(50006; "Actual Qty"; Decimal)
        {
        }
        field(50007; "Actual Price"; Decimal)
        {
        }
        field(50008; "Issued Quantity"; Decimal)
        {
            trigger OnValidate()
            begin
        ...
        field(50009; "Issued Units"; Decimal)
        {
            trigger OnValidate()
            begin
        ...
        field(50010; "Issued Price"; Decimal)
        {
        }
        field(50011; Dosage; Text[100])
        {
        }
        field(50012; Remarks; Text[200])
        {
        }
        field(50013; Pharmacy; Code[20])
        {
            TableRelation = Location.Code;
        }
        field(50014; Remaining; Decimal)
        {
        }
        ...
        field(50022; "Invoice Counter"; Integer)
        {
            FieldClass = Normal;
        }
        field(50023; "Link Code"; Code[20])
        {
        }
        field(50024; "Link Type LK"; Code[20])
        {
            CalcFormula = lookup("HMS Treatment Form Header"."Link No." where("Treatment No." = field("Linking No.")));
            FieldClass = FlowField;
        }
        field(50025; "Posted Doc No"; Code[20])
        {
        }
        field(50026; Location; Code[20])
        {
            TableRelation = Location.Code;
        ...
        field(50029; Route; Enum "Drug Routes")
        {            
        }
        field(50030; Frequency; Integer)
        {
        ...
        field(50041; "Number of Days"; Integer)
        {
        ...
        field(50042; "Returns Quantity"; Decimal)
        {
        }
        field(50043; Reversed; Boolean)
        {
        }
        field(50044; "line no"; Integer)
        {
            AutoIncrement = true;
        }
        field(50045; "Total Price"; Decimal)
        {
        }
        field(50046; Status; Option)
        {
            CalcFormula = lookup("HMS Pharmacy Header".Status where("Pharmacy No." = field("Pharmacy No.")));
            FieldClass = FlowField;
            OptionMembers = New,Completed,Cancelled;
        }
        field(50047; "Issue Date"; Date)
        {
            CalcFormula = lookup("HMS Pharmacy Header"."Pharmacy Date" where("Pharmacy No." = field("Pharmacy No.")));
            FieldClass = FlowField;
        }
        field(50048; Names; Text[200])
        {
            CalcFormula = lookup("HMS Patient"."Search Name" where("Patient No." = field("Patient No")));
            FieldClass = FlowField;
        }
        field(50049; "Insurance Amount"; Decimal)
        {
        }
        field(50050; "Insurance Total Amount"; Decimal)
        {
        }
        field(50051; "Unit Cost"; Decimal)
        {
        }
        field(50052; "Prescription Dose"; Enum PrescriptionDoseEnum)
        {
            DataClassification = ToBeClassified;
        }
        field(50053; "Item Journal"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50054; "Global Dimension Code 1"; Code[20])
        {
            CalcFormula = lookup("HMS Pharmacy Header"."Global Dimension 1 Code" where("Pharmacy No." = field("Pharmacy No.")));
            FieldClass = FlowField;
            CaptionClass = '1,1,1';
        }
        field(50055; "Description2"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
        field(50031; "Insurance No1"; Code[20])
        {
            CalcFormula = Lookup("HMS Patient"."Insurance No." where("Patient No." = field("Patient No"), "Patient Type" = filter(Corporate)));
            FieldClass = FlowField;
        }
        field(50032; "Sale Type"; Boolean)
        {
            CalcFormula = Lookup("HMS Pharmacy Header"."Cash Sale" where("Pharmacy No." = field("Pharmacy No.")));
            FieldClass = FlowField;
        }
        field(50033; Posted; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50034; "Date Filter"; Date)
        {
            FieldClass = FlowFilter;
        }
        field(50035; "Insurance code"; Code[20])
        {
            CalcFormula = Lookup("HMS Patient"."Insurance No." where("Patient No." = field("Patient No")));
            FieldClass = FlowField;
        }
        field(50036; "pharm count Walkin Cash"; Integer)
        {
        ...
        field(50037; Branch; Code[20])
        {
            CalcFormula = lookup("HMS Pharmacy Header"."Global Dimension 1 Code" where("Pharmacy No." = field("Pharmacy No.")));
            FieldClass = FlowField;
        }
        field(50038; "Capitation Amount"; Decimal)
        {
        }
        field(50039; "Minimum Price"; Decimal)
        {
            CalcFormula = lookup(Item."Minimum Unit Price" where("No." = field("No.")));
            FieldClass = FlowField;
        }
        field(50040; "Maximum Price"; Decimal)
        {
            CalcFormula = lookup(Item."Maximum Unit Price" where("No." = field("No.")));
            FieldClass = FlowField;
        }
        field(50056; "Returns Posted"; Boolean)
        {
