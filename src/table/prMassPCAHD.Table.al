Table 85529 prMassPCAHD
{
    ...
    fields
    {
        field(50000; "Change Advice Serial No."; Code[50])
        {
            trigger OnValidate()
            begin
        ...
        field(50004; "Payroll Period"; Date)
        {
            TableRelation = "prPayroll Periods"."Date Opened" where(Closed = const(false));
        }
        field(50005; Comments; Text[200])
        {
        }
        field(50006; "No. Series"; Code[10])
        {
            Editable = false;
            TableRelation = "No. Series";
        }
        field(50007; Effected; Boolean)
        {
        }
        ...
        field(50010; PAyrollCode; Code[50])
        {
            TableRelation = "prPayroll Type";
        }
        field(50011; "Transaction Code"; Code[30])
        {
