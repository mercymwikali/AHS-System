Table 85293 "HR Job Applications"
{
    ...
    fields
    {
        ...
        field(50057; "Employee Requisition No"; Code[20])
        {
        ...
        field(50058; "Total Score"; Decimal)
        {
            CalcFormula = sum("HR Job Applicants - Appt. Res".Score where("Applicant No" = field("Application No")));
            FieldClass = FlowField;
        }
        field(50059; Shortlist; Boolean)
        {
        }
        field(50060; Qualified; Boolean)
        {
            Editable = false;
        }
        field(50061; Stage; Code[20])
        {
            FieldClass = FlowFilter;
        }
        field(50062; "No. Series"; Code[20])
        {
            Caption = 'No. Series';
            Editable = false;
            TableRelation = "No. Series";
        }
        field(50063; "Employee No"; Code[20])
        {
                ...
                if Employee.Get("Employee No") then begin
                    ...
                    begin
                        ...
                        repeat
                            ...
                            AppQualifications.Qualification := EmpQualifications."Qualification Type";
        ...
        field(50064; "Applicant Type"; Option)
        {
            Editable = false;
            OptionCaption = 'External,Internal';
            OptionMembers = External,Internal;
        }
        field(50065; "Interview Invitation Sent"; Boolean)
        {
            Editable = false;
        }
        field(50066; "Date Applied"; Date)
        {
        }
        field(50067; "Citizenship Details"; Text[60])
        {
        }
        field(50068; "Date of Interview"; Date)
        {
        }
        field(50069; "From Time"; Time)
        {
        }
        field(50070; "To Time"; Time)
        {
        }
        field(50071; Venue; Text[30])
        {
        }
        field(50072; "Interview Type"; Option)
        {
            OptionCaption = 'Writen,Practicals,Oral,Oral&Written';
            OptionMembers = Writen,Practicals,Oral,"Oral&Written";
        }
        field(50073; Select; Boolean)
        {
        }
        field(50074; "Job Applied for Description"; Text[100])
        {
        }
        field(50075; "Selection Count"; Integer)
        {
            CalcFormula = count("HR Applicants Shortlist" where("Job Application No" = field("Application No")));
            FieldClass = FlowField;
        }
        field(50076; "Marked For Interview(Stage1)"; Boolean)
        {
        }
        field(50077; "Marked For Interview(Stage2)"; Boolean)
        {
        }
        field(50078; "Qualified To Hire"; Boolean)
        {
        }
        field(50079; "Room No"; Text[30])
        {
        }
        field(50080; Floor; Text[30])
        {
        }
        field(50081; "User Name"; Code[50])
        {
        }
        field(50082; "Requisition No"; Code[50])
        {
        }
    }
