...
table 85177 "HMS Appointment Form Header"
{
    ...
    fields
    {
        field(50000; "Appointment No."; Code[20])
        {
            Editable = false;
        ...
        field(50001; "Appointment Date"; Date)
        {
        }
        field(50002; "Appointment Time"; Time)
        {
        }
        field(50003; "Appointment Type"; Code[20])
        {
        ...
        field(50097; "Doctor Name"; Text[100])
        {
        ...
        field(50011; Status; Enum AppointmentStatusEnum)
        {
        }
        field(50012; "ReAppointment No."; Code[20])
        {
        }
        field(50013; "ReAppointment Date"; Date)
        {
        }
        field(50014; "ReAppointment Time"; Time)
        {
        }
        field(50015; "ReAppointment Type Code"; Code[20])
        {
            TableRelation = "HMS Setup Appointment Type".Code;
        }
        field(50016; "ReAppointment Doctor ID"; Code[20])
        {
        ...
        field(50018; "Dispatch To"; Enum "Dispatch Areas")
        {
        ...
        field(50019; "Dispatch Date"; Date)
        {
        }
        field(50020; "Dispatch Time"; Time)
        {
        }
        field(50021; "User ID"; Code[100])
        {
            TableRelation = User."User Name";
        }
        field(50022; "Treatment Status"; Option)
        {
        ...
        field(50023; "Settlement Type"; Option)
        {
        ...
        field(50043; "Insurance Member No"; Code[50])
        {
        }
        field(50044; "Link No"; Code[20])
        {
        }
        field(50045; "Doctors Name"; Text[250])
        {
        }
        field(50046; "Patient Names"; Text[250])
        {
        }
        field(50047; "Age in Years"; Integer)
        {
        }
        field(50048; Gender; Option)
        {
            OptionCaption = ' ,Male,Female';
            OptionMembers = " ",Male,Female;
        }
        field(50049; visitType; Option)
        {
            OptionCaption = 'New,Revisit';
            OptionMembers = New,Revisit;
        }
        field(50050; Emergency; Boolean)
        {
        }
        field(50051; Names; Text[250])
        {
            FieldClass = Normal;
        }
        field(50052; SearchNames; Text[250])
        {
        }
        field(50053; imported; Boolean)
        {
        }
        field(50054; Minor; Boolean)
        {
        }
        field(50055; Physio; Boolean)
        {
        }
        field(50056; "SmarkLink Balance"; Decimal)
        {
        }
        field(50057; "MVC No."; Text[50])
        {
        ...
        field(50058; "Patient Category"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Dimension Value".Code where("Global Dimension No." = CONST(3));
        }
        field(50059; "Phone No"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(50060; "Waiting At"; Enum "Dispatch Areas")
        {
            DataClassification = ToBeClassified;
        ...
        field(50061; "Triage Time In"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50062; "Triage Time out"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50063; "Doctor Time In"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50064; "Doctor Time Out"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50065; "Lab Time In"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50066; "Lab Time Out"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50067; "Pharmacy Time In"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50068; "Pharmacy Time Out"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50069; "Imaging Time In"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50070; "Imaging Time Out"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50071; "Posted Invoice No"; Code[20])
        {
            CalcFormula = lookup("HMS Patient Charges"."Invoice Number" where("Patient No." = field("Patient No."),
                                                                               "Visit No" = field("Appointment No.")));
            FieldClass = FlowField;
        }
        field(50072; "Total Billed"; Decimal)
        {
            CalcFormula = sum("HMS Patient Charges"."Total Amount" where("Patient No." = field("Patient No."),
                                                                          "Visit No" = field("Appointment No."),
        ...
        field(50075; "Global Dimension 1"; Code[30])
        {
            CalcFormula = lookup("HMS Patient"."Global Dimension 1 Code" where("Patient No." = field("Patient No.")));
            FieldClass = FlowField;
        }
        field(50076; "Invoince No"; Code[20])
        {
            CalcFormula = lookup("Sales Invoice Header"."No." where("Appointment No" = field("Appointment No.")));
            FieldClass = FlowField;
        }
        field(50077; "Booked By"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(50078; Time; time)
        {
            DataClassification = ToBeClassified;
        }
        field(50079; "Therapy Time In"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(50080; "Special Clinics"; Code[30])
        {
        ...
        field(50081; "Insurance LOU Amount"; decimal)
        {
            DataClassification = ToBeClassified;
            trigger OnValidate()
            begin
        ...
        field(50082; "NHIF Procedure Code"; code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50083; "Re-Opened"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50084; "Re-Opened Date"; date)
        {
            DataClassification = ToBeClassified;
        }
        field(50085; "Re-Opened UserID"; code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50086; "Doctor Appointment count"; Integer)
        {
            CalcFormula = count("HMS Appointment Form Header" where(Doctor = field("Doctor"),
                                                                     "Patient No." = field("Patient No.")));
            FieldClass = FlowField;
        }
        field(50087; "Doctor Last Appointment Date"; date)
        {
            FieldClass = FlowField;
        ...
        field(50088; "Date Filter"; date)
        {
            FieldClass = FlowFilter;

        }
        field(50089; "Telephone No."; Code[100])
        {
            CalcFormula = lookup("HMS Patient"."Telephone No. 1" where("Patient No." = field("Patient No.")));
            FieldClass = FlowField;
        }
        field(50090; "Visit Type"; Code[20])
        {
            TableRelation = "HMS Setup Appointment Type".Code;
        }
        field(50091; "Invoice No"; Code[20])
        {

        }
        field(50092; isTherapy; Boolean)
        {

        }
        field(50093; "Treatment No"; Code[20])
        {

        }
        field(50094; isTranscription; Boolean)
        {

        }
        field(50095; "Transcribed By"; Code[30])
        {

        }
        field(50096; "Transcribed Date"; Date)
        {
