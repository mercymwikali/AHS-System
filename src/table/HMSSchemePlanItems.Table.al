Table 85237 "HMS Scheme Plan Items"
{
    fields
    {
        ...
        field(50008; "Base Unit of Measure"; Code[10])
        {
        ...
        field(50010; "Inventory Posting Group"; Code[10])
        {
            Caption = 'Inventory Posting Group';
            DataClassification = ToBeClassified;
            TableRelation = "Inventory Posting Group";
        }
        field(50011; "Shelf No."; Code[10])
        {
            Caption = 'Shelf No.';
            DataClassification = ToBeClassified;
        }
        field(50012; "Price Unit Conversion"; Integer)
        {
            Caption = 'Price Unit Conversion';
            DataClassification = ToBeClassified;
        }
        field(50013; "Item Disc. Group"; Code[20])
        {
            Caption = 'Item Disc. Group';
            DataClassification = ToBeClassified;
            TableRelation = "Item Discount Group";
        }
        field(50014; "Allow Invoice Disc."; Boolean)
        {
            Caption = 'Allow Invoice Disc.';
            DataClassification = ToBeClassified;
            InitValue = true;
        }
        field(50015; "Statistics Group"; Integer)
        {
            Caption = 'Statistics Group';
            DataClassification = ToBeClassified;
        }
        field(50016; "Commission Group"; Integer)
        {
            Caption = 'Commission Group';
            DataClassification = ToBeClassified;
        }
        field(50017; "Price/Profit Calculation"; Option)
        {
