Table 85542 "prSalary Card"
{
    fields
    {
        ...
        field(50027; "Cumm Employer Pension"; Decimal)
        {
            CalcFormula = sum("prEmployer Deductions".Amount where("Employee Code" = field("Employee Code"),
                                                                    "Transaction Code" = const('0007')));
            FieldClass = FlowField;
        }
        field(50028; "Pays Pension"; Boolean)
        {
        }
        field(50029; "Current Round Up"; Decimal)
        {
        }
        field(50030; "Current Round Down"; Decimal)
        {
        }
        field(50031; "Preveous Round Down"; Decimal)
        {
        }
        field(50032; "Preveous Round Up"; Decimal)
        {
        }
        field(50033; "Period Month"; Integer)
        {
        }
        field(50034; "Period Year"; Integer)
        {
        }
        field(50035; "Current Month"; Integer)
        {
        }
        field(50036; "Current Year"; Integer)
        {
        }
        field(50037; "Payroll Period"; Date)
        {
            TableRelation = "prPayroll Periods"."Date Opened";
        }
        field(50038; Closed; Boolean)
        {
            CalcFormula = lookup("prPayroll Periods".Closed where("Date Opened" = field("Payroll Period")));
            FieldClass = FlowField;
        }
        field(50039; "Employee Status"; Option)
        {
        ...
        field(50040; "Gratuity Perc."; Decimal)
        {
        }
        field(50041; "Has Pension"; Integer)
        {
            CalcFormula = count("prEmployee Transactions" where("Employee Code" = field("Employee Code"),
                                                                 "Transaction Code" = filter('352')));
            FieldClass = FlowField;
        }
        field(50042; "Pays 30% PAYE"; Boolean)
        {
            Caption = 'Pays 35% PAYE';
            DataClassification = ToBeClassified;
        }
        field(50043; "Gets PAYE Relief"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50044; "Pays AHL"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50045; "Pays SHA"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50046; "Pays NSSF Tier 1"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50047; "Pays NSSF Tier 2"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50048; "Selected Period"; Date)
        {
            FieldClass = FlowField;
