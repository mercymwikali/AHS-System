Table 85422 "HR Medical Claims"
{
    //  DrillDownPageID = UnknownPage70135038;
    // LookupPageID = UnknownPage70135038;
    ...
    fields
    {
        ...
        field(50001; "Claim Type"; Option)
        {
            OptionMembers = Inpatient,Outpatient;
        }
        field(50002; "Claim Date"; Date)
        {
        }
        field(50003; "Patient Name"; Text[100])
        {
        }
        field(50004; "Document Ref"; Text[50])
        {
        }
        field(50005; "Date of Service"; Date)
        {
        }
        field(50006; "Facility Attended"; Code[10])
        {
            // TableRelation = "HR Medical Facility".Code;
            /*
                        trigger OnValidate()
                        begin
                            Facility.Reset;
        ...
        field(50007; "Claim Amount"; Decimal)
        {
            trigger OnValidate()
            begin
        ...
        field(50010; Dependants; Code[50])
        {
        ...
        */
        ...
        field(50012; "No. Series"; Code[60])
        {
        }
        field(50013; "No Series"; Code[50])
        {
        }
        field(50014; "Scheme No"; Code[10])
        {
            TableRelation = "HR Medical Schemes" where(Status = filter(<> Closed));
        ...
        field(50015; "Member Names"; Text[100])
        {
        }
        ...
        field(50020; "Facility Name"; Text[50])
        {
        }
        field(50021; "Scheme Currency Code"; Code[10])
        {
            TableRelation = Currency;
        }
        field(50022; "Scheme Amount Charged"; Decimal)
        {
        }
        field(50023; "Currency Factor"; Decimal)
        {
            trigger OnValidate()
            begin
                Curr.Reset();
        ...
        field(50024; "Claim Currency Code"; Code[10])
        {
            TableRelation = Currency;
        }
    }
    ...
    var
        // Facility: Record UnknownRecord70135275;
        Curr: Record Currency;
        CurrExchRate: Record "Currency Exchange Rate";
        HREmp: Record "HR-Employee";
        MDependants: Record "HR Employee Kin";
        HRMSMembers: Record "HR Medical Scheme Members";
