Table 85210 "HMS Patient Charges"
{
    ...
    fields
    {
        ...
        field(50002; "Transaction Type"; Code[50])
        {
        ...
        field(50129; "Shortcut Dimension 3 Code"; Code[20])
        {
        ...
        field(50130; "Shortcut Dimension 4 Code"; Code[20])
        {
        ...
        field(50012; Recognized; Boolean)
        {
        }
        field(50013; Posted; Boolean)
        {
        }
        field(50014; "Pharmacy No"; Code[20])
        {
            TableRelation = "HMS Pharmacy Header"."Pharmacy No.";
        }
        field(50015; Location; Code[20])
        {
            TableRelation = Location.Code;
        }
        field(50016; "Doctors Amount"; Decimal)
        {
        }
        field(50017; "Recovered First"; Boolean)
        {
        }
        field(50018; Transfer; Boolean)
        {
        }
        field(50019; "Transfer Amount"; Decimal)
        {
        }
        field(50020; Transfered; Boolean)
        {
        }
        field(50021; "Invoice ID"; Code[20])
        {
            trigger OnValidate()
        ...
        field(50023; "Fully Paid"; Boolean)
        {
        }
        field(50024; "Room Allocation"; Code[20])
        {
            Editable = true;
            Enabled = true;
        }
        field(50025; Charge; Boolean)
        {
        }
        field(50026; Reversed; Boolean)
        {
            trigger OnValidate()
            begin
                if GuiAllowed then
        ...
        field(50027; Distribution; Decimal)
        {
        }
        ...
        field(50029; "Invoice Number"; Code[20])
        {
        }
        field(50030; "Applied Payment"; Decimal)
        {
        }
        field(50031; "Recovery Priority"; Integer)
        {
        }
        field(50032; "Full Tuition Fee"; Decimal)
        {
        }
        field(50033; "Distribution Account"; Code[20])
        {
            TableRelation = "G/L Account";
        }
        field(50034; Currency; Code[20])
        {
            TableRelation = Currency.Code;
        }
        field(50035; "Over Charged"; Boolean)
        {
        }
        field(50036; "Over Charged Amount"; Decimal)
        {
        }
        field(50037; "System Created"; Boolean)
        {
        }
        field(50038; "Charge Gender"; Option)
        {
            FieldClass = Normal;
            OptionCaption = ' ,Male,Female';
            OptionMembers = " ",Male,Female;
        }
        field(50039; "Customer No."; Code[20])
        {
            TableRelation = Customer."No.";
        }
        field(50040; "Bill Section"; Enum "Charges Applicable Section")
        {
            FieldClass = Normal;
        }
        field(50041; "Line No"; Integer)
        {
            AutoIncrement = true;
        }
        field(50042; "G/L Account"; Code[20])
        {
            CalcFormula = lookup("HMS Transactions code"."Income G/L Account" where("Transaction Type" = field("Transaction Type")));
            FieldClass = FlowField;
        }
        field(50043; "Treatment No."; Code[20])
        {
            // TableRelation = "HMS Appointment Form Header"."Appointment No." where("Patient No." = field("Patient No."));
        }
        field(50044; "Invoice Counter"; Integer)
        {
            FieldClass = Normal;
        }
        field(50045; "Applicable Section"; Enum "Charges Applicable Section")
        {
        ...
        field(50046; "Link No"; Code[50])
        {
        }
        field(50047; "Link No Lk"; Code[20])
        {
            CalcFormula = lookup("HMS Treatment Form Header"."Link No." where("Treatment No." = field("Treatment No.")));
            FieldClass = FlowField;
        }
        field(50048; "Appointment No."; Code[20])
        {
            // TableRelation = "HMS Appointment Form Header"."Appointment No." where("Patient No." = field("Patient No."));
        }
        field(50049; "Patient Type Lk"; Option)
        {
        ...
        field(50050; "Appointment No Lk"; Code[20])
        {
            CalcFormula = lookup("HMS Appointment Form Header"."Appointment No." where("Patient No." = field("Patient No.")));
            FieldClass = FlowField;
        }
        field(50051; "Billing Type"; Option)
        {
            OptionCaption = 'Once,Reccuring';
            OptionMembers = Once,Reccuring;
        }
        field(50052; "Billing Start Date"; Date)
        {
        }
        field(50053; "Billing End Date"; Date)
        {
        }
        field(50054; "Admission No"; Code[20])
        {
        }
        field(50055; "Doctor ID"; Code[20])
        {
        ...
        field(50056; "Dimension Set ID"; Integer)
        {
        ...
        field(50057; "New Dimension Set ID"; Integer)
        {
        ...
        field(50058; "G/L Account No"; Code[20])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(50059; "Weiver Amount"; Decimal)
        {
        }
        field(50060; "Weiver Reason"; Text[200])
        {
        }
        field(50061; "Weiver Approval Status"; Option)
        {
            OptionCaption = 'New,Pending Approval,Approved,Rejected';
            OptionMembers = New,"Pending Approval",Approved,Rejected;
        }
        field(50062; "User ID"; Code[70])
        {
        }
        field(50063; "Creation Time"; Time)
        {
        }
        field(50064; "Creation Date"; Date)
        {
        }
        field(50065; "Weiver Code"; Code[20])
        {
        }
        field(50125; "Weived"; Boolean)
        {
        }
        field(50128; "Posted to Doctor"; Boolean)
        {
        }
        field(50066; "Original Amount"; Decimal)
        {
        }
        field(50067; "Reccuring Type"; Option)
        {
            OptionCaption = ' ,Daily,Hourly';
            OptionMembers = " ",Daily,Hourly;
        }
        field(50068; "Insurance Amount"; Decimal)
        {
        }
        field(50069; Claimed; Boolean)
        {
        }
        field(50070; "Claim Receipt No"; Code[20])
        {
        }
        field(50071; "Doctor Rate"; Decimal)
        {
        }
        field(50072; "Posted Invoice No."; Code[20])
        {
            CalcFormula = lookup("Sales Invoice Header"."No." where("No." = field("Invoice Number")));
            FieldClass = FlowField;
        }
        field(50073; "Total Receipts"; Decimal)
        {
            CalcFormula = sum("HMS Patient Charges".Amount where("Patient No." = field("Patient No."),
                                                                  Amount = filter(< 0)));
            FieldClass = FlowField;
        }
        field(50074; "Calc Doctor Fee"; Boolean)
        {
        ...
        field(50076; "Default Insurance"; Code[20])
        {
            CalcFormula = lookup("HMS Patient"."Insurance No." where("Patient No." = field("Patient No.")));
            FieldClass = FlowField;
        }
        field(50077; "Doctors Name"; Text[200])
        {
            CalcFormula = lookup("HMS Setup Doctor"."Doctors Name" where("Doctor ID" = field("Doctor ID")));
            FieldClass = FlowField;
        }
        field(50078; "Total Amount"; Decimal)
        {
            Editable = true;
        }
        field(50079; Imported; Boolean)
        {
        }
        field(50080; "Invoice Amount"; Decimal)
        {
        ...
        field(50081; Closed; Boolean)
        {
        }
        field(50082; "Location Code"; Code[20])
        {
            TableRelation = Location;
        }
        field(50083; "Appointment No"; Code[10])
        {
        }
        field(50084; "Visit No"; Code[20])
        {
            // TableRelation = "HMS Appointment Form Header"."Appointment No." where("Patient No." = field("Patient No."));
        ...
        field(50085; Medicentre; Boolean)
        {
        }
        field(50086; InPatient; Boolean)
        {
        }
        field(50087; "Charge Balance"; Decimal)
        {
            CalcFormula = sum("HMS Patient Charges".Amount where("Patient No." = field("Patient No."),
        ...
        field(50088; "Own Debtor"; Boolean)
        {
            trigger OnValidate()
            begin
        ...
        field(50089; "Cash Rebates Posted"; Boolean)
        {
        }
        field(50090; "Receipt Reversed"; Boolean)
        {
            CalcFormula = lookup("Bank Account Ledger Entry".Reversed where("Document No." = field(Code)));
            FieldClass = FlowField;
        }
        field(50091; Sunflash; Boolean)
        {
        }
        field(50092; "Claimed Count"; Integer)
        {
            FieldClass = Normal;
        }
        field(50093; "Claimed Amount"; Decimal)
        {
        ...
        field(50094; "Insurance Paid Amount"; Decimal)
        {
        ...
        field(50109; "Patient Type"; Code[20])
        {
        }
        field(50110; "Receipt Amount"; Decimal)
        {
        ...
        field(50111; "Posting Document No"; code[20])
        {
            FieldClass = Normal;
        }
        field(50124; "Doctors Posting No"; code[20])
        {
            FieldClass = Normal;
        }
        field(50112; "Exist In GL"; Boolean)
        {
            CalcFormula = exist("G/L Entry" where("Document No." = field("Posting Document No")));
            FieldClass = FlowField;
        }
        field(50113; "Visit Amount"; decimal)
        {
            CalcFormula = Sum("HMS Patient Charges"."Total Amount" where("Patient No." = field("Patient No."),
                                                             "Visit No" = field("Visit No")));
            FieldClass = FlowField;
        }
        field(50115; "Current LOU Amount"; decimal)
        {
        ...
        field(50114; "Charge Type"; Option)
        {
            FieldClass = Normal;
            OptionCaption = 'Service,Item';
            OptionMembers = Service,Item;
        }
        field(50116; "Corporate Excluded"; Boolean)
        {
            FieldClass = Normal;
            trigger OnValidate()
        ...
        field(50117; "Visit Paid Amount"; decimal)
        {
            CalcFormula = Sum("HMS Patient Charges".Amount where("Patient No." = field("Patient No."),
                                                             "Visit No" = field("Visit No"), Amount = filter(< 0)));
            FieldClass = FlowField;
        }
        field(50118; "Is Bed"; Boolean)
        {
            CalcFormula = exist("HMS Beds" where("Bed No" = field(Code)));
            FieldClass = FlowField;
        }
        field(50119; "Inventory Posting Group"; Code[20])
        {
            CalcFormula = lookup(Item."Inventory Posting Group" where("No." = field("Code")));
            FieldClass = FlowField;
        }
        field(50120; "Select"; Boolean)
        {
        }
        field(50121; "Package Item"; Boolean)
        {
        }
        field(50122; "Receipt posted"; Boolean)
        {
        }
        field(50123; "Admitting Doctor"; Code[30])
        {
            FieldClass = FlowField;
