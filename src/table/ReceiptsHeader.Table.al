Table 85133 "Receipts Header"
{
    ...
    fields
    {
        ...
        field(50002; Cashier; Code[20])
        {
            Description = 'Stores the user id of the cashier';
            TableRelation = User."User Name";
        }
        field(50003; "Date Posted"; Date)
        {
        }
        field(50004; "Time Posted"; Time)
        {
        }
        ...
        field(50010; "Amount Recieved"; Decimal)
        {
            trigger OnValidate()
            begin
                TotalBalance := 0;
        ...
        field(50013; "Currency Code"; Code[10])
        {
        ...
        field(50016; "Posted By"; Code[20])
        {
        }
        field(50017; "Print No."; Integer)
        {
        }
        ...
        field(50019; "Cheque No."; Code[20])
        {
        }
        field(50020; "No. Printed"; Integer)
        {
        }
        field(50021; "Created By"; Code[50])
        {
        }
        field(50022; "Created Date Time"; DateTime)
        {
        }
        field(50023; "Register No."; Integer)
        {
        }
        field(50024; "From Entry No."; Integer)
        {
        }
        field(50025; "To Entry No."; Integer)
        {
        }
        field(50026; "Document Date"; Date)
        {
        }
        field(50027; "Receipt Split Amount"; Decimal)
        {
            CalcFormula = sum("Receipt Split".Amount where("Receipt No" = field("No.")));
            FieldClass = FlowField;
        }
        field(50028; "Split Amount"; Boolean)
        {
            trigger OnValidate()
            begin
        ...
        field(50030; "Shortcut Dimension 3 Code"; Code[20])
        {
        ...
        field(50031; "Shortcut Dimension 4 Code"; Code[20])
        {
        ...
        field(50032; Dim3; Text[250])
        {
        }
        field(50033; Dim4; Text[250])
        {
        }
        field(50034; "Bank Name"; Text[250])
        {
        }
        field(50035; "Receipt Reference"; Option)
        {
            Editable = false;
            OptionMembers = Normal,"Travel Advance Refunds","Other Advance Refunds";
        }
        field(50036; "Staff Number"; Code[20])
        {
        }
        field(50037; "Patient No."; Code[20])
        {
        ...
        field(50038; "Patient Appointment No"; Code[20])
        {
        ...
        field(50040; "Manual Ref.Number"; Text[30])
        {
        }
        field(50041; "Imprest No"; Code[20])
        {
            TableRelation = "Imprest Header"."No." where(Status = const(Approved));
        }
        field(50042; "Application No"; Code[20])
        {
        }
        field(50043; "Applicant Name"; Text[100])
        {
        }
        field(50044; "Pay Mode Lk"; Option)
        {
        ...
        field(50045; "Pharmacy No"; Code[20])
        {
        ...
        field(50046; "Laboratory No"; Code[20])
        {
            FieldClass = Normal;
        ...
        field(50047; "Customer No"; Code[20])
        {
        ...
        field(50064; "Reversed Posted"; Boolean)
        {
        }
        field(50063; "Reversed By"; code[20])
        {
        }
        field(50062; "Reversal Date"; date)
        {
        }
        field(50049; Reversed; Boolean)
        {
            CalcFormula = lookup("Bank Account Ledger Entry".Reversed where("Document No." = field("No.")));
            FieldClass = FlowField;
        }
        field(50050; "Mobile Money Type"; Option)
        {
        ...
        field(50051; "Pay Mode"; Enum "Payment Modes")
        {
            trigger OnValidate()
            begin
                "Bank Code" := '';
        ...
        field(50054; "Bank Balance"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50055; "InterBank No"; code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50056; "InterBank No Filter"; code[20])
        {
            FieldClass = FlowFilter;
        }
        field(50057; "Disbursable Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50058; "Disbursed Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50059; "Fully Disbursed"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50060; "isPartialPayment"; Boolean)
        {
            DataClassification = ToBeClassified;
