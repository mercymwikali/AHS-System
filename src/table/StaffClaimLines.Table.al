Table 85017 "Staff Claim Lines"
{
    fields
    {
        ...
        field(50034; "Lecturer No"; Code[20])
        {
            TableRelation = "HR-Employee"."No." where(Lecturer = const(true));
        }
        field(50035; "Campus Code"; Code[20])
        {
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(1));
        }
        field(50039; "Budgeted Amount"; Decimal)
        {
        ...
        field(50038; "Actual Expenditure"; Decimal)
        {
        ...
        field(50040; "Date Filter"; Date)
        {
            FieldClass = FlowFilter;
        }
        field(50036; "Medical Amount"; Decimal)
        {
            trigger OnValidate()
            begin
                ClaimLines.Reset();
