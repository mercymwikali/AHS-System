TableExtension 85013 "G/L Account Ext" extends "G/L Account"
{
    ...
    fields
    {
        field(50100; "Budget Controlled"; Boolean)
        {
        }
        field(50101; "Global Dimension 3 Filter"; Code[20])
        {
        ...
        field(50102; "Global Dimension 4 Filter"; Code[20])
        {
        ...
        field(50103; "Expense Code"; Code[15])
        {
        ...
        field(50104; "Donor defined Account"; Boolean)
        {
            Description = 'Select if the Account is donor Defined';
        }
        field(50105; "Committment Amount"; Decimal)
        {
        ...
        field(50109; test; Code[20])
        {
        }
        field(50110; "Grant Expense"; Boolean)
        {
        }
        field(50111; Status; Option)
        {
            Editable = true;
            OptionMembers = New,"Pending Approval",Approved,Rejected;
        }
        field(50112; "Responsibility Center"; Code[20])
        {
            TableRelation = "Responsibility Center BR".Code;
        }
        field(50113; "Quartely Budget line Items"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50106; "Budget Line Item"; Code[20])
        {
            // TableRelation = ; TODO: include table relation
            DataClassification = ToBeClassified;
        }
        field(50107; "IP/OP"; Option)
        {
            FieldClass = FlowFilter;
            OptionMembers = ,OP,IP;
        }
        field(50108; "Patient Type"; Option)
        {
            FieldClass = FlowFilter;
