Query 52202493 "HR Job applications"
{
    elements
    {
        dataitem(HR_Job_Applications; "HR Job Applications")
        {
            ...
            column(Date_of_Interview; "Date of Interview")
            {
            }
            column(From_Time; "From Time")
            {
            }
            column(To_Time; "To Time")
            {
            }
            column(Venue; Venue)
            {
            }
            column(Interview_Type; "Interview Type")
            {
            }
            ...
            column(Selection_Count; "Selection Count")
            {
            }
            column(Marked_For_Interview_Stage1; "Marked For Interview(Stage1)")
            {
            }
            column(Marked_For_Interview_Stage2; "Marked For Interview(Stage2)")
            {
            }
            column(Qualified_To_Hire; "Qualified To Hire")
            {
            }
