table 52202660 "HMS Pharmacy Header"
{
    ...
    fields
    {
        ...
        field(56; "Global Dimension 1 Code"; Code[30])
        {
            CaptionClass = '1,1,1';
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(1));
        ...
        field(62; "pharm count Walkin Cash"; Integer)
        {
        ...
        field(64; "Insurance code"; Code[20])
        {
            CalcFormula = Lookup("HMS Patient"."Insurance No." where("Patient No." = field("Patient No.")));
            FieldClass = FlowField;
        }
        field(65; "pharm count Walkin Normal"; Integer)
        {
            CalcFormula = Count("HMS Pharmacy Header" where("Pharmacy Date" = field("Date Filter"), "Cash Sale" = filter(true), "Patient Type" = filter(Cash), Walkin = filter(true)));
            FieldClass = FlowField;
        }
        field(66; "Capitation Amount"; Decimal)
        {
