page 52202733 "HMS Admission Header Admitted"
{
    PageType = Card;
    ...
    actions
    {
        ...
        area(Navigation)
        {
            ...
            action(SuicidalPrecaution)
            {
                ...
                RunPageLink = "Admission No." = field("Admission No.");
                ToolTip = 'Executes the Suicidal Precaution Form action.';
            }
            action(MSEChecklistForm)
            {
                ...
                RunPageLink = "Admission No." = field("Admission No.");
                ToolTip = 'Executes the Mental Status Level Checklist action.';
            }
