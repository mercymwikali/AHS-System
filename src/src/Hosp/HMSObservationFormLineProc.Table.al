Table 52202501 "HMS Observation Form Line Proc"
{
    fields
    {
        ...
        field(22; "Blood Sugars"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(23; "Chief Complaints"; Blob)
        {
            DataClassification = ToBeClassified;
        }
        field(24; "Systolic Bp"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(25; "Diastolic Bp"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
    }
