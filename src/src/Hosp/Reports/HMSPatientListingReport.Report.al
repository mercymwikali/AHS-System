report 52202618 "HMS Patient Listing Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Patients/HMSPatientListingReport.rdl';
        ...
        dataitem("HMS Patient"; "HMS Patient")
        {
            ...
            begin
                ...
                if Patient.Get("Patient No.") then begin
                    PatientName := Copystr(UpperCase(Patient.Surname + ' ' + Patient."Middle Name" + ' ' + Patient."Last Name"), 1, 200);
                    case Patient."Patient Type" of
                        Patient."Patient Type"::Corporate:
                            PFNo := Patient."Employee No.";
                        Patient."Patient Type"::" ":
                            PFNo := Patient."Patient No.";
                        Patient."Patient Type"::Cash:                        
                            PFNo := Patient."Employee No.";
