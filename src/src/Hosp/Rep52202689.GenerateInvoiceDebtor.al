report 52202689 "Generate Invoice Debtor"
{
    Caption = 'Generate Invoice Debtor';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("HMS Patient Charges"; "HMS Patient Charges")
        {
            ...
            begin
                ...
                HMSPat.GenerateInvoice("HMS Patient Charges".GetFilter("Patient No."), "HMS Patient Charges".GetFilter("Visit No"), true, UserId);
            end;
        }
    }
