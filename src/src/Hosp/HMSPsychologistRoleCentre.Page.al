page 52203103 "HMS Psychologist Role Centre"
{
    Caption = 'Psychologist Role Center';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            // TODO : Add Doctors Room Waiting List Cue
        ...
        area(sections)
        {
            ...
            group(Therapy)
            {
                ...
                action("CLosed Therapy Sessions")
                {
                    ...
                    RunObject = Page "HMS Treatment List(Psychology)";
                    RunPageView = where(isTherapy = filter(true), Status = filter(<> Active | New));
