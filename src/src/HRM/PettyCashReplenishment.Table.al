table 52202993 "Petty Cash Replenishment"
{
    ...
    fields
    {
        field(1; "Replenishement No"; Code[30])
        {
            Caption = 'Replenishment No';
        }
        field(2; "Requesting User"; Code[30])
        {
        ...
        field(9; "Posted InterBank Transfer No"; Code[30])
        {
        ...
        field(11; "Requisition Date"; Date)
        {
        ...
        field(13; "Request Amount"; Decimal)
        {
