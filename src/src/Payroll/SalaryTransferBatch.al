report 52202486 "Salary Transfer Batch2"
{
    ProcessingOnly = true;
            ...
            begin
                ...
                IF PeriodTrans.FINDSET(FALSE, FALSE) THEN BEGIN
                    ...
                    CreateJnlEntry(0, PeriodTrans."Journal Account Code",
                            GlobalDim1, GlobalDim2, PeriodTrans."Transaction Name" + '-' + PeriodTrans."Transaction Code", AmountToCredit, 0, 1, PeriodTrans."Loan Number", SaccoTransactionType);
                END;
                //End Bpay
                ...
                IF PeriodTrans.FINDSET(FALSE, FALSE) THEN BEGIN
                    ...
                    CreateJnlEntry(0, PostingGroup."SHIF Employee Account",
                            GlobalDim1, GlobalDim2, PeriodTrans."Transaction Name" + '-' + PeriodTrans."Transaction Code", 0, AmountToCredit, PeriodTrans."Post As", PeriodTrans."Loan Number", SaccoTransactionType);
                END;
                //END NHIF
