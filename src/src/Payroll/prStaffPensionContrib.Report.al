Report 52202546 "prStaff Pension Contrib"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/prStaffPensionContrib.rdl';
    ...
    dataset
    {
        dataitem("prSalary Card"; "prSalary Card")
        {
            ...
            begin
                ...
                PeriodTrans.SetRange(PeriodTrans."Transaction Code", 'D0003');
