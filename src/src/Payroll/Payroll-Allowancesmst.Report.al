Report 52202583 "Payroll - Allowances mst"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PayrollAllowancesmst.rdl';
    ...
    dataset
    {
        ...
        dataitem("HR-Employee"; "HR-Employee")
        {
            ...
            column(KENYA_WATER_INSITUTE_; 'MULTIMEDIA UNIVERSITY OF SCIENCE & TECHNOLOGY')
            {
            }
