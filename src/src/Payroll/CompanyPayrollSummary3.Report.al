Report 52202603 "Company Payroll Summary 3"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/CompanyPayrollSummary3.rdl';
                ...
                if prPeriod_Transactions.Find('-') then begin
                    ...
                    repeat
                        ...
                        if prPeriod_Transactions.Amount > 0 then begin
                            ...
                            (prPeriod_Transactions."Group Order" = 3) or
                             ((prPeriod_Transactions."Group Order" = 4) and (prPeriod_Transactions."Sub Group Order" <> 0))) then begin // A Payment
                                ...
                                begin
                                    countz := countz + 1;
                                    if (PayTrans[countz]) = prPeriod_Transactions."Transaction Name" then
                                        found := true;
                                end;
                       ...
                       ((prPeriod_Transactions."Group Order" = 8) and (prPeriod_Transactions."Sub Group Order" <> 9))) then begin
                                    ...
                                    begin
                                        countz := countz + 1;
                                        if (DedTrans[countz]) = prPeriod_Transactions."Transaction Name" then
                                            found := true;
                                    end;
    ...
    var
        ...
        SelectedPeriod: Date;
        DED: Decimal;
        DedTransAmt: array[120] of Decimal;
        GPY: Decimal;
        HLEVY: Decimal;
        NETS: Decimal;
        ...
        PeriodName: Text[30];
        DetDate: Text[100];
        DedTrans: array[120] of Text[250];
