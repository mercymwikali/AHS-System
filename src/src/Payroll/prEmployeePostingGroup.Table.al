Table 52202613 "prEmployee Posting Group"
{
    ...
    fields
    {
        ...
        field(18; StaffGratuityDebit; Code[50])
        {
            TableRelation = "G/L Account";
        }
        field(19; "SHIF Employee Account"; Code[50])
        {
            TableRelation = "G/L Account";
        }
        ...
        field(23; StaffGratuityCredit; Code[50])
        {
            TableRelation = "G/L Account";
        }
        ...
        field(27; "NHIF Employee Account"; Code[50])
        {
            TableRelation = "G/L Account";
        }
    }
