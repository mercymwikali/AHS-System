        ...
        area(content)
        {
            group(Control1)
            {
                ...
                field("Function Name"; Rec."Function Name")
                {
                    ...
                    Editable = false;
                    ToolTip = 'Specifies the value of the Branch Description field.';
                }
                ...
                field("Doctors Batch No"; Rec."Doctors Batch No")
                {
                    ToolTip = 'Specifies the value of the Doctors Batch No field.';
                }
            }
        ...
        area(Reporting)
        {
            action(Print)
            {
                ...
                begin
                    ...
                    REPORT.Run(Report::"Payment Voucher Vend", true, true, Rec);  //For imprest or claim
            ...
            action("Print Applied Invoice")
            {
                ...
                begin
                    IF Rec."Doctors Batch No" = '' THEN BEGIN
                        ...
                        IF rcpt.FIND('-') THEN
                            REPORT.RUN(Report::"Payment Voucher App Inv", TRUE, TRUE, rcpt);
                    ...
                    END ELSE BEGIN
                        ...
                        IF PatVisit.FIND('-') THEN
                            REPORT.RUN(Report::"Payment Voucher App Inv2", TRUE, TRUE, PatVisit);
                    END;
                end;
            }
            ...
            action("Reverse Posted Entries")
            {
                ...
                begin
                    ...
                    if Rec."Posted Count" = 0 then
                        Error('Posted entries does not exists in the ledgers for the selected document');
