tableextension 52202446 "Item Ledger Entry Ext" extends "Item Ledger Entry"
{
    fields
    {
        field(70134600; "Patient Name"; Text[100])
        {
            CalcFormula = lookup("HMS Patient"."Search Name" where("Patient No." = field("Source No.")));
