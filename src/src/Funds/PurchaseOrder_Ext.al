pageextension 52202439 "Purchase Order Ext" extends "Purchase Order"
{
    layout
    {
            ...
            action("Print Order")
            {
                ...
                begin
                    ...
                    if PurchRec.find('-') then
                        report.Run(Report::"Purchase Order2", true, true, PurchRec);
                end;
            }
            action("Print LSO")
            {
                ...
                begin
                    ...
                    PurchRec.setfilter("No.", Rec."No.");
                    if PurchRec.find('-') then
                        report.Run(Report::"LSO Report", true, true, PurchRec);
                end;
            }
        }
