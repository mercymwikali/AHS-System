table 52202989 "Visits with Unsynced Charges"
{
    ...
    fields
    {
        ...
        field(3; "Patient Number"; Code[30])
        {
        ...
        field(4; "Posted Invoice Number"; Code[20])
        {
            Caption = 'Posted Invoice Number';
        }
        field(5; "Synched with sales Invoice"; Boolean)
        {
            Caption = 'Synched with sales Invoice';
        }
        field(6; "First Invoice number"; Code[20])
        {
            // fieldclass = FlowField;
