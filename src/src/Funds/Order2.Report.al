Report 52202428 "Order 2"
{
    Caption = 'Order';
    DefaultLayout = RDLC;
    PreviewMode = PrintLayout;
    RDLCLayout = './Layouts/Order2.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PaymentstrermsCode; "Purchase Header"."Payment Terms Code")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Currency_Code; PurchLine."Currency Code")
                    {
                    }
                    ...
                    dataitem(PrepmtVATCounter; "Integer")
                    {
                        ...
                        column(Purchase_Due_Date; "Purchase Header"."Prepayment Due Date")
                        {
                        }
            ...
            begin
                ...
                if ApprovalEntry.Find('-') then begin
                    ...
                    UserName1 := UserRec.UserName + ' - ' + ApprovalEntry."Approver ID";
                end;
                ...
                if ApprovalEntry.Find('-') then begin
                    ...
                    UserRec.Get(ApprovalEntry."Last Modified By User ID");
                    UserName2 := UserRec.UserName + ' - ' + ApprovalEntry."Approver ID";
                end;
