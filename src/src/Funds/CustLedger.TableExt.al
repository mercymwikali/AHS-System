tableextension 52202453 "Cust.Ledger Entry Ext" extends "Cust. Ledger Entry"
{
    fields
    {
        field(51000; "Patient No"; code[20])
        {
            CalcFormula = lookup("Sales Invoice Header"."Patient No." where("No." = field("Document No.")));
            FieldClass = FlowField;
        }
        field(51001; "Patient Name"; Text[100])
        {
        ...
        field(50109; "Old Customer No."; Code[20])
        {
        }
    }
}