Table 85236 "HMS Scheme Plan Header"
{
    ...
    fields
    {
        ...
        field(50010; "Document Sending Profile"; Code[20])
        {
            Caption = 'Document Sending Profile';
            TableRelation = "Document Sending Profile".Code;
        }
        field(50011; "Our Account No."; Text[20])
        {
        ...
        field(50016; "Budgeted Amount"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Budgeted Amount';
        }
        field(50017; "Credit Limit (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Credit Limit (LCY)';
        }
        field(50018; "Customer Posting Group"; Code[10])
        {
        ...
        field(50020; "Customer Price Group"; Code[10])
        {
