Table 85209 "HMS Patient"
{
    ...
    fields
    {
        ...
        field(50006; "Middle Name"; Text[50])
        {
        ...
        field(50016; "Telephone No. 1"; Code[30])
        {
        ...
        field(50108; "Search Name"; Text[250])
        {
        }
        ...
        field(50116; "Discharged Type"; Enum DischargeTypesEnum)
        {
        ...
        field(50118; "Special Clinics"; Code[30])
        {
        ...
        field(50170; "Scheme Name"; Code[100])
        {
            // TableRelation = "Insurance Scheme Setup"."Scheme Name" where("Insurance Code" = field("Insurance No."));
        }
        field(50171; "Period Appointment Count"; Integer)
        {
            CalcFormula = count("HMS Appointment Form Header" where("Patient No." = field("Patient No."),
                                                                     "Appointment Date" = field("Date Filter")));
            FieldClass = FlowField;
        }
        field(50172; "Invoice No Filter"; Code[20])
        {
            FieldClass = FlowFilter;
        }
        field(50173; CurrentBenefitNumber; Integer)
        {
        }
        field(50174; "Bill Balance SMS"; Decimal)
        {
            CalcFormula = sum("HMS Patient Charges"."Total Amount" where("Patient No." = field("Patient No."),
                                                                          Closed = const(false),
                                                                          "Receipt Reversed" = const(false),
        ...
        field(50175; Dependant; Boolean)
        {
        }
        field(50176; "Patient Type2"; Option)
        {
        ...
        field(50177; "Student No."; Code[20])
        {

        }
        field(50178; "Relative No."; Code[20])
        {

        }
        field(50179; "Active Appointment date"; date)
        {

        }
        field(50181; "How you Knew About Us"; code[100])
        {
            TableRelation = "Marketing Strategies".Code;
        }
        field(50180; "Pending Admission Count"; Integer)
        {
            FieldClass = FlowField;
            CalcFormula = count("HMS Admission Form Header" where(Status = filter(New)));
        }
        field(50182; "Current Appointment date"; date)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("HMS Appointment Form Header"."Appointment Date" where("Appointment No." = field("Active Visit No")));
        }
        field(50183; "Current Special Clinics"; Code[30])
        {
            FieldClass = FlowField;
        ...
        field(50184; "Last Billing Date"; date)
        {
        }
        field(50185; "Current LOU Amount"; Decimal)
        {
        }
        field(50186; "Principal"; Boolean)
        {
            trigger OnValidate()
            begin
        ...
        field(50189; "Sub-County code"; code[30])
        {
        ...
        field(50190; "Principal Member Name"; Code[250])
        {
        }
        field(50191; "No. of Insurance List"; Integer)
        {
            FieldClass = FlowField;
            CalcFormula = count("HMS Patient Insuarance" where("Patient No" = field("Patient No.")));
        }
        field(50192; "Active Cashier"; Code[20])
        {
        }
    }
