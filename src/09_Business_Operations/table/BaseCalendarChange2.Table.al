Table 85023 "Base Calendar Change2"
{
    ...
    fields
    {
        field(50000; "Base Calendar Code"; Code[10])
        {
            Caption = 'Base Calendar Code';
            Editable = false;
            TableRelation = "Base Calendar";
        }
        field(50001; "Recurring System"; Option)
        {
        ...
        field(50004; Description; Text[30])
        {
            Caption = 'Description';
        }
        field(50005; Nonworking; Boolean)
        {
            Caption = 'Nonworking';
            InitValue = true;
        }
        field(50006; "Date Month"; Option)
        {
