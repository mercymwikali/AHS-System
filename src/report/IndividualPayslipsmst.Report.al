Report 85232 "Individual Payslips mst"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/IndividualPayslipsmst.rdl';
        ...
        dataitem("prSalary Card"; "prSalary Card")
        {
            ...
            begin
                ...
                if objEmp.Find('-') then begin
                    ...
                    EmployeeStatutories := strPin + ', ' + strNhifNo + ', ' + strNssfNo;
            ...
            begin
                ...
                if not GuiAllowed then
                    Evaluate(PeriodFilter, "prSalary Card".GetFilter("prSalary Card"."Period Filter"));
