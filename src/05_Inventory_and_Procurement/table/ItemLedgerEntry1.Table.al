Table 85059 "Item Ledger Entry1"
{
    ...
    fields
    {
        ...
        field(50005; "Document No."; Code[20])
        {
            Caption = 'Document No.';
        }
        ...
        field(50010; "Invoiced Quantity"; Decimal)
        {
            Caption = 'Invoiced Quantity';
            DecimalPlaces = 0 : 5;
        }
        field(50011; "Applies-to Entry"; Integer)
        {
            Caption = 'Applies-to Entry';
        }
        field(50012; Open; Boolean)
        {
            Caption = 'Open';
        }
        ...
        field(50015; Positive; Boolean)
        {
            Caption = 'Positive';
        }
        field(50016; "Source Type"; Option)
        {
            Caption = 'Source Type';
            OptionCaption = ' ,Customer,Vendor,Item';
            OptionMembers = " ",Customer,Vendor,Item;
        }
        field(50017; "Drop Shipment"; Boolean)
        {
            AccessByPermission = TableData "Drop Shpt. Post. Buffer" = R;
            Caption = 'Drop Shipment';
        }
        field(50018; "Transaction Type"; Code[10])
        {
            Caption = 'Transaction Type';
            TableRelation = "Transaction Type";
        }
        field(50019; "Transport Method"; Code[10])
        {
            Caption = 'Transport Method';
            TableRelation = "Transport Method";
        }
        field(50020; "Country/Region Code"; Code[10])
        {
            Caption = 'Country/Region Code';
            TableRelation = "Country/Region";
        }
        field(50021; "Entry/Exit Point"; Code[10])
        {
            Caption = 'Entry/Exit Point';
            TableRelation = "Entry/Exit Point";
        }
        field(50022; "Document Date"; Date)
        {
        ...
        field(50024; "Area"; Code[10])
        {
            Caption = 'Area';
            TableRelation = Area;
        }
        field(50025; "Transaction Specification"; Code[10])
        {
        ...
        field(50027; "Reserved Quantity"; Decimal)
        {
        ...
        field(50029; "Document Line No."; Integer)
        {
        ...
        field(50031; "Order No."; Code[20])
        {
            Caption = 'Order No.';
            Editable = false;
        }
        field(50032; "Order Line No."; Integer)
        {
            Caption = 'Order Line No.';
            Editable = false;
        }
        field(50033; "Dimension Set ID"; Integer)
        {
        ...
        field(50034; "Assemble to Order"; Boolean)
        {
            AccessByPermission = TableData "BOM Component" = R;
            Caption = 'Assemble to Order';
        }
        field(50035; "Job No."; Code[20])
        {
            Caption = 'Job No.';
            TableRelation = Job."No.";
        }
        field(50036; "Job Task No."; Code[20])
        {
            Caption = 'Job Task No.';
            TableRelation = "Job Task"."Job Task No." where("Job No." = field("Job No."));
        }
        field(50037; "Job Purchase"; Boolean)
        {
            Caption = 'Job Purchase';
        }
        field(50038; "Variant Code"; Code[10])
        {
        ...
        field(50040; "Unit of Measure Code"; Code[10])
        {
            Caption = 'Unit of Measure Code';
            TableRelation = "Item Unit of Measure".Code where("Item No." = field("Item No."));
        }
        field(50041; "Derived from Blanket Order"; Boolean)
        {
            Caption = 'Derived from Blanket Order';
        }
        field(50042; "Cross-Reference No."; Code[20])
        {
        ...
        field(50045; "Out-of-Stock Substitution"; Boolean)
        {
            Caption = 'Out-of-Stock Substitution';
        }
        field(50046; "Item Category Code"; Code[10])
        {
            Caption = 'Item Category Code';
            TableRelation = "Item Category";
        }
        field(50047; Nonstock; Boolean)
        {
            Caption = 'Nonstock';
        }
        field(50048; "Purchasing Code"; Code[10])
        {
            Caption = 'Purchasing Code';
            TableRelation = Purchasing;
        }
        field(50049; "Product Group Code"; Code[10])
        {
            Caption = 'Product Group Code';
            // TableRelation = "Product Group".Code where ("Item Category Code"=field("Item Category Code"));
        }
        field(50050; "Completely Invoiced"; Boolean)
        {
            Caption = 'Completely Invoiced';
        }
        field(50051; "Last Invoice Date"; Date)
        {
            Caption = 'Last Invoice Date';
        }
        field(50052; "Applied Entry to Adjust"; Boolean)
        {
            Caption = 'Applied Entry to Adjust';
        }
        field(50053; "Cost Amount (Expected)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50054; "Cost Amount (Actual)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50055; "Cost Amount (Non-Invtbl.)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50056; "Cost Amount (Expected) (ACY)"; Decimal)
        {
        ...
        field(50057; "Cost Amount (Actual) (ACY)"; Decimal)
        {
            AutoFormatExpression = GetCurrencyCode();
            AutoFormatType = 1;
        ...
        field(50058; "Cost Amount (Non-Invtbl.)(ACY)"; Decimal)
        {
            AutoFormatExpression = GetCurrencyCode();
            AutoFormatType = 1;
        ...
        field(50059; "Purchase Amount (Expected)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50060; "Purchase Amount (Actual)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50061; "Sales Amount (Expected)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50062; "Sales Amount (Actual)"; Decimal)
        {
            AutoFormatType = 1;
        ...
        field(50063; Correction; Boolean)
        {
            Caption = 'Correction';
        }
        field(50064; "Shipped Qty. Not Returned"; Decimal)
        {
            AccessByPermission = TableData "Sales Header" = R;
            Caption = 'Shipped Qty. Not Returned';
            DecimalPlaces = 0 : 5;
        }
        field(50065; "Prod. Order Comp. Line No."; Integer)
        {
            AccessByPermission = TableData "Production Order" = R;
            Caption = 'Prod. Order Comp. Line No.';
        }
        field(50066; "Serial No."; Code[20])
        {
            Caption = 'Serial No.';
        ...
        field(50068; "Warranty Date"; Date)
        {
            Caption = 'Warranty Date';
        }
        field(50069; "Expiration Date"; Date)
        {
            Caption = 'Expiration Date';
        }
        field(50070; "Item Tracking"; Option)
        {
        ...
        field(50071; "Return Reason Code"; Code[10])
        {
    ...
    var
        ...
        GLSetupRead: Boolean;
        IsNotOnInventoryErr: label 'You have insufficient quantity of Item %1 on inventory.', Comment='%1';
