TableExtension 52202428 "Purchase Line Ext" extends "Purchase Line"
{
    fields
    {
        modify("No.")
        ...
        */
        ...
        field(50041; "Reason for Request"; Code[800])
        {
        }
        ...
        field(99000761; "G/L Account"; Code[10])
        {
            FieldClass = Normal;
        }
        field(51233; "Patient No"; Code[20])
        {
            FieldClass = Normal;
